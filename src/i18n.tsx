...
const translations: Record<AppLanguage, Record<string, string>> = {
  en: {
    ...
    "session.toolResultError": "Tool error",
    "session.emptyThinking": "No thinking content available.",
    "session.loadMore": "Load more messages",
    ...
    "worktree.confirmPrune": "Prune stale Git worktree metadata? This only removes stale records that Git considers prunable.",
  ...
  zh: {
    ...
    "session.toolResultError": "工具错误",
    "session.emptyThinking": "没有可显示的思考内容。",
    "session.loadMore": "加载更多消息",
    ...
    "worktree.title": "工作树",
    "worktree.main": "主工作树",
    "worktree.empty": "没有找到工作树",
    "worktree.dirty": "有变更",
    "worktree.prune": "清理",
    "worktree.confirmPrune": "清理 Git 判定为可清理的陈旧工作树元数据？此操作不会删除正常工作树。",
